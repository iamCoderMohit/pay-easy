  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <div className="card-title">OUR USER<br />
          <span>OUR USER IS GREAT (YES, THAT'S YOU)</span>
        </div>
        <div className="card-socials">
          <button className="card-socials-btn facebook">
            <svg className="icon" xmlns="http://www.w3.org/2000/svg" width={24} viewBox="0 0 24 24" id="Layer_21" height={24} data-name="Layer 21"><title /><path d="M16.75,9H13.5V7a1,1,0,0,1,1-1h2V3H14a4,4,0,0,0-4,4V9H8v3h2v9h3.5V12H16Z" /></svg>
          </button>
